    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FM', ' заказ формируется'), ('STP', 'заказ отправлен в обработку'), ('PD', 'заказ оплачен'), ('PRD', 'заказ обрабатывется'), ('RDY', ' заказ готов'), ('CNC', 'отмена заказа')], default='FM', max_length=3, verbose_name='статус')),
